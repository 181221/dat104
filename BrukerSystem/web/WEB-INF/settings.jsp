...
<%@ page import="static no.hvl.dat104.controller.UrlMappings.SETTINGS_URL" %><%--
...
<div class="container">
    <div class="row">
        ...
        <h1 style="text-align: center">Oppdater passord</h1>
        <div style="width: 30%; margin: 25px auto;">
            <form action="<%= SETTINGS_URL%>" method="POST">
                ...
                <div class="form-group">
                    <input class="form-control" type="password" name="password1" placeholder="passord">
                </div>
                <div class="form-group">
